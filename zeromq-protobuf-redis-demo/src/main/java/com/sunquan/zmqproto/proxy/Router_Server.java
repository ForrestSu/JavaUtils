    ...
    public static void main(String[] argv1) throws Exception
    {
        ...
        while(brun) 
        {
            ...
            do {
                ...
                System.out.println("more: " + more + ", data="+ Arrays.toString(data));
            }while(more);
            System.out.println("frame size:" + frames.size());
            
            // send response
            for(int i=0; i< frames.size()-1; ++i) {
                skt.sendMore(frames.get(i));
            }
            String respmsg = "hello "+ new String(frames.get(frames.size()-1), "utf-8");
            
            System.out.println("Resp:[" + respmsg + "]");
            skt.send(respmsg);
        }

...
final class JsonMarshaller {
     ...
     * This is an unstable API and has not been optimized yet for performance.
     */
    public static <T extends Message> Marshaller<T> jsonMarshaller(final T defaultInstance, final Parser parser,
        ...
        return new Marshaller<T>() {
            ...
            public InputStream stream(T value) {
                try {
                    ...
                    throw Status.INTERNAL.withCause(e).withDescription("Unable to print json proto")
                            .asRuntimeException();
                }
            }

 ...
 *
 * <p>
 * This is an advanced example of how to swap out the serialization logic. Normal users do not need to do this. This
 * code is not intended to be a production-ready implementation, since JSON encoding is slow. Additionally, JSON
 * serialization as implemented may be not resilient to malicious input.
 *
 * <p>
...
public class HelloJsonServer {
    ...
    private static class GreeterImpl implements BindableService {
        ...
        public ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(GreeterGrpc.getServiceDescriptor().getName())
                    .addMethod(HelloJsonClient.HelloJsonStub.METHOD_SAY_HELLO,
                            asyncUnaryCall(new UnaryMethod<HelloRequest, HelloReply>() {
                                @Override
